var wrapperEle=document.body.querySelector(".content");
var counter = 0;
function makeHome(){
...
function makeAbout(){
  ...
  nameEle.innerHTML="Ameer Salama"
...
document.body.querySelector(".homebutt").addEventListener("click",
 function(){
  makeHome();
})
document.body.querySelector(".aboutbutt").addEventListener("click",
 function(){
  makeAbout();
  })
document.body.querySelector(".interactbutt").addEventListener("click",
 function(){
  makeInteract();
})
document.body.querySelector("#counter").addEventListener("click",
 function(){
  counterUP();
})
